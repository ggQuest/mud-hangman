...
library UsedLetters {
  ...
  /** Get value1 */
  function get(bytes1 key1) internal view returns (bool value1) {
  ...
  function get(IStore _store, bytes1 key1) internal view returns (bool value1) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key1));
  ...
  /** Set value1 */
  function set(bytes1 key1, bool value1) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key1));
  ...
  function set(IStore _store, bytes1 key1, bool value1) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key1));
  ...
  function encodeKeyTuple(bytes1 key1) internal pure returns (bytes32[] memory _keyTuple) {
    _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key1));
  }

  /* Delete all data for given keys */
  function deleteRecord(bytes1 key1) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key1));
  ...
  function deleteRecord(IStore _store, bytes1 key1) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key1));

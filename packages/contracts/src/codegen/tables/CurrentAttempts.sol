...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("CurrentAttempts")));
bytes32 constant CurrentAttemptsTableId = _tableId;

library CurrentAttempts {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("CurrentAttempts", _fieldNames);
  }
